<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.PageUpdateSystem" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <head>
      ...
      <link href="./assets/bootstrap/css/bootstrap.min.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/core.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/components.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/pages.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/menu.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/responsive.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <link href="./assets/css/ionicons.min.css?v=6.5.1" rel="stylesheet" type="text/css" />
      <script src="./assets/jquery/jquery-1.9.1.min.js?v=6.5.1" type="text/javascript"></script>
      <script src="./assets/sweetalert/sweetalert.min.js?v=6.5.1" type="text/javascript"></script>
      <script src="./assets/layer/layer.min.js?v=6.5.1" type="text/javascript"></script>
      <script src="./inc/script.js?v=6.5.1" type="text/javascript"></script>
      <style>
        body {
          padding: 20px 0;
        }
    ...
    <script src="assets/vue/vue.min.js?v=6.5.1"></script>
    <script src="assets/js/apiUtils.js?v=6.5.1"></script>
    <script src="assets/js/compareversion.js?v=6.5.1"></script>
