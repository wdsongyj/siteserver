<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.Plugins.PageView" %>
  ...
  <head>
    ...
    <link href="../assets/showLoading/css/showLoading.css?v=6.5.1" rel="stylesheet" />
    <script type="text/javascript" src="../assets/showLoading/js/jquery.showLoading.js?v=6.5.1"></script>
  </head>
