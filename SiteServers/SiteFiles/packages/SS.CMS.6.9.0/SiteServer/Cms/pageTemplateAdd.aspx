              ...
              <script type="text/javascript">
                $(document).ready(function () {
                  var editor = CodeMirror.fromTextArea('TbContent', {
                    height: "500px",
                    parserfile: ["parsecss.js?v=6.9.0", "tokenizejavascript.js?v=6.9.0", "parsejavascript.js?v=6.9.0", "parsexml.js?v=6.9.0", "parsehtmlmixed.js?v=6.9.0"],
                    stylesheet: ["../assets/codeMirror/css/xmlcolors.css?v=6.9.0", "../assets/codeMirror/css/csscolors.css?v=6.9.0", "../assets/codeMirror/css/jscolors.css?v=6.9.0"],
