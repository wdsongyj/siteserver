...
<head>
  ...
  <script type="text/javascript" src="../assets/validate.js?v=6.9.0"></script>
  <script type="text/javascript" src="../assets/jquery/jquery.form.js?v=6.9.0"></script>
  <script type="text/javascript" src="../assets/jscolor/jscolor.js?v=6.9.0"></script>
  <script>
