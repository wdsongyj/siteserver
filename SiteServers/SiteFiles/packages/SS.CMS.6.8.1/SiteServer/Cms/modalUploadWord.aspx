<%@ Page Language="C#" Trace="false" Inherits="SiteServer.BackgroundPages.Cms.ModalUploadWord" %>
	<%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
		...
		<script type="text/javascript" src="../assets/web-uploader/js/Q.js?v=6.8.1"></script>
		<script type="text/javascript" src="../assets/web-uploader/js/Q.Uploader.js?v=6.8.1"></script>
		<script type="text/javascript">
			var data = {
				op: '',
				file: null,
