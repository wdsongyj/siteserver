<%@ Page Language="C#" Inherits="SiteServer.BackgroundPages.PageMain" Trace="False" EnableViewState="false" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <script src="assets/signalR/jquery.signalR-2.2.2.min.js?v=6.6.2" type="text/javascript"></script>
    ...
    <script src="assets/jQuery-slimScroll/jquery.slimscroll.min.js?v=6.6.2" type="text/javascript"></script>
