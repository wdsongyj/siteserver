<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.BackgroundPages.Cms.PageTemplateAssetsAdd" %>
  <%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
    ...
    <head>
      ...
      <script src="../assets/codeMirror/js/codemirror.js?v=6.6.2" type="text/javascript"></script>
    </head>
                ...
                <script type="text/javascript">
                  $(document).ready(function () {
                    var editor = CodeMirror.fromTextArea('TbContent', {
                      height: "500px",
                      parserfile: ["parsecss.js?v=6.6.2", "tokenizejavascript.js?v=6.6.2", "parsejavascript.js?v=6.6.2", "parsexml.js?v=6.6.2",
                        "parsehtmlmixed.js?v=6.6.2"
                      ],
                      stylesheet: ["../assets/codeMirror/css/xmlcolors.css?v=6.6.2",
                        "../assets/codeMirror/css/csscolors.css?v=6.6.2", "../assets/codeMirror/css/jscolors.css?v=6.6.2"
                      ],
              ...
              <asp:PlaceHolder id="PhCodeMirrorJs" visible="false" runat="server">
                <script type="text/javascript">
                  $(document).ready(function () {
                    var editor = CodeMirror.fromTextArea('TbContent', {
                      height: "500px",
                      parserfile: ["tokenizejavascript.js?v=6.6.2", "parsejavascript.js?v=6.6.2"],
                      stylesheet: ["../assets/codeMirror/css/jscolors.css?v=6.6.2"],
                      path: "../assets/codeMirror/js/",
                      continuousScanning: 500,
                      lineNumbers: true
                    });
              ...
              <asp:PlaceHolder id="PhCodeMirrorCss" visible="false" runat="server">
                <script type="text/javascript">
                  $(document).ready(function () {
                    var editor = CodeMirror.fromTextArea('TbContent', {
                      height: "500px",
                      parserfile: ["parsecss.js?v=6.6.2"],
                      stylesheet: ["../assets/codeMirror/css/csscolors.css?v=6.6.2"],
                      path: "../assets/codeMirror/js/",
                      continuousScanning: 500,
                      lineNumbers: true
                    });
