              ...
              <script type="text/javascript">
                $(document).ready(function () {
                  var editor = CodeMirror.fromTextArea('TbContent', {
                    height: "500px",
                    parserfile: ["parsecss.js?v=6.6.2", "tokenizejavascript.js?v=6.6.2", "parsejavascript.js?v=6.6.2", "parsexml.js?v=6.6.2", "parsehtmlmixed.js?v=6.6.2"],
                    stylesheet: ["../assets/codeMirror/css/xmlcolors.css?v=6.6.2", "../assets/codeMirror/css/csscolors.css?v=6.6.2", "../assets/codeMirror/css/jscolors.css?v=6.6.2"],
