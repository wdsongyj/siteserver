<%@ Page Language="C#" Trace="false" Inherits="SiteServer.BackgroundPages.Cms.ModalUploadWord" %>
	<%@ Register TagPrefix="ctrl" Namespace="SiteServer.BackgroundPages.Controls" Assembly="SiteServer.BackgroundPages" %>
		...
		<script type="text/javascript" src="../assets/vue/vue.min.js?v=6.6.2"></script>
		<script type="text/javascript" src="../assets/web-uploader/js/Q.js?v=6.6.2"></script>
		<script type="text/javascript" src="../assets/web-uploader/js/Q.Uploader.js?v=6.6.2"></script>
		<script type="text/javascript">
			var data = {
				op: '',
				file: null,
